...
TODO: Go through all the files and assign an authorship to it
...
--Save the raw html of the webpage after the conclusion of a game
--The html files will be deleted once all the important info is stripped (not deleting yet in case i want more info in the future)
...
--The program may not crash if everything lines up perfectly, however it is not robust in any sense and CAN NOT be considered fully functional
