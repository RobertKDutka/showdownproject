	...
	start() {
		...
		if (this.debugMode) {
			this.checkEVBalance();
                                    ...
                                    /**
                                    * for (const side of this.sides){
                                    *    this.add('my debug', side.id);
                                    *     for (const pokemon of side.pokemon) {
                                    *         this.add('d', pokemon.name);
                                    *         this.add('d', pokemon.types)
                                    *         let array = Object.getOwnPropertyNames(pokemon.storedStats);
                                    *         this.add('d', array);
                                    *         this.add('d', pokemon.storedStats.atk, pokemon.storedStats.def, pokemon.storedStats.spa, pokemon.storedStats.spd,pokemon.storedStats.spe,pokemon.storedStats.hp);
                                    *         this.add('\n');
                                    *     }
                                    * }
                                    */
